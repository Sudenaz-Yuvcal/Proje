  ...
  return (
    <div className="min-h-screen bg-[#f8f9fc] py-12 px-4 font-sans text-slate-600">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        Alışveriş Listesi </h1>
        
        <div className="grid grid-cols-3 gap-6">

          <div className="bg-blue-100 border-2 border-solid  p-6 rounded-xl 
          shadow-[0_10px_30px_rgba(0,0,0,0.04)] text-center transition-transform hover:scale-105">
          ...
          <div className="bg-green-100 border-2 border-solid p-6 rounded-xl
           shadow-[0_10px_30px_rgba(0,0,0,0.04)] text-center transition-transform hover:scale-105">
          ...
          <div className="bg-rose-100 border-2 border-solid p-6 rounded-xl
           shadow-[0_10px_30px_rgba(0,0,0,0.04)] text-center transition-transform hover:scale-105">
